...
# -----------------------------
# 3️⃣ field name standardization
# -----------------------------
df.rename(columns={
    'Test No.': 'Test_No',
...
# -----------------------------
# 6️⃣ removed the outlier Negative SPL >3σ 
# -----------------------------
...
# -----------------------------
# 7️⃣ cauculated the limit of parameter
# -----------------------------
# Cycle1_mbar
...
# -----------------------------
# 8️⃣ organize the method parameter table
# -----------------------------
limits = pd.DataFrame({
